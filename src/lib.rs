// src/lib.rs
/*
 * Core library for CrossoverApex
 */
...
#[derive(Debug)]
pub struct CrossoverApexProcessor {
    verbose: bool,
    processed_count: usize,
}

impl CrossoverApexProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting CrossoverApex processing");
    
    let mut processor = CrossoverApexProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = CrossoverApexProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = CrossoverApexProcessor::new(false);
